...
public class BlockMasterWorkerService {
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public GetCachePermissionTResponse recv_getCachePermission() throws org.apache.thrift.TException
    {
      getCachePermission_result result = new getCachePermission_result();
      receiveBase(result, "getCachePermission");
      if (result.isSetSuccess()) {
        return result.success;
      }
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public static class getCachePermission_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public GetCachePermissionTResponse getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getCachePermission();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getCachePermission", new getCachePermission());
    ...
    public static class getCachePermission<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getCachePermission_args> {
      public getCachePermission() {
        super("getCachePermission");
      }

      public getCachePermission_args getEmptyArgsInstance() {
        return new getCachePermission_args();
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class getCachePermission<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getCachePermission_args, GetCachePermissionTResponse> {
      public getCachePermission() {
        super("getCachePermission");
      }
      ...
      public AsyncMethodCallback<GetCachePermissionTResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<GetCachePermissionTResponse>() { 
          public void onComplete(GetCachePermissionTResponse o) {
            getCachePermission_result result = new getCachePermission_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
  ...
  public static class getCachePermission_args implements org.apache.thrift.TBase<getCachePermission_args, getCachePermission_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCachePermission_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getCachePermission_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getCachePermission_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getCachePermission_args.class, metaDataMap);
    }
    ...
    public getCachePermission_args deepCopy() {
      return new getCachePermission_args(this);
    }
     ...
     * the id of the block
     */
    public getCachePermission_args setBlockId(long blockId) {
      this.blockId = blockId;
      setBlockIdIsSet(true);
      return this;
    }
     ...
     * the method options
     */
    public GetCachePermissionTOptions getOptions() {
      return this.options;
    }
     ...
     * the method options
     */
    public getCachePermission_args setOptions(GetCachePermissionTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((GetCachePermissionTOptions)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getCachePermission_args)
        return this.equals((getCachePermission_args)that);
      return false;
    }

    public boolean equals(getCachePermission_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getCachePermission_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getCachePermission_args(");
      boolean first = true;
    ...
    private static class getCachePermission_argsStandardSchemeFactory implements SchemeFactory {
      public getCachePermission_argsStandardScheme getScheme() {
        return new getCachePermission_argsStandardScheme();
      }
    }

    private static class getCachePermission_argsStandardScheme extends StandardScheme<getCachePermission_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getCachePermission_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCachePermission_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getCachePermission_argsTupleSchemeFactory implements SchemeFactory {
      public getCachePermission_argsTupleScheme getScheme() {
        return new getCachePermission_argsTupleScheme();
      }
    }

    private static class getCachePermission_argsTupleScheme extends TupleScheme<getCachePermission_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getCachePermission_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetBlockId()) {
          optionals.set(0);
  ...
  public static class getCachePermission_result implements org.apache.thrift.TBase<getCachePermission_result, getCachePermission_result._Fields>, java.io.Serializable, Cloneable, Comparable<getCachePermission_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getCachePermission_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getCachePermission_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getCachePermission_resultTupleSchemeFactory());
    }

    private GetCachePermissionTResponse success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GetCachePermissionTResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getCachePermission_result.class, metaDataMap);
    }

    public getCachePermission_result() {
    }

    public getCachePermission_result(
      GetCachePermissionTResponse success)
    {
      this();
      this.success = success;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getCachePermission_result(getCachePermission_result other) {
      if (other.isSetSuccess()) {
        this.success = new GetCachePermissionTResponse(other.success);
      }
    }

    public getCachePermission_result deepCopy() {
      return new getCachePermission_result(this);
    }
    ...
    public GetCachePermissionTResponse getSuccess() {
      return this.success;
    }

    public getCachePermission_result setSuccess(GetCachePermissionTResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((GetCachePermissionTResponse)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getCachePermission_result)
        return this.equals((getCachePermission_result)that);
      return false;
    }

    public boolean equals(getCachePermission_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getCachePermission_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getCachePermission_result(");
      boolean first = true;
    ...
    private static class getCachePermission_resultStandardSchemeFactory implements SchemeFactory {
      public getCachePermission_resultStandardScheme getScheme() {
        return new getCachePermission_resultStandardScheme();
      }
    }

    private static class getCachePermission_resultStandardScheme extends StandardScheme<getCachePermission_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getCachePermission_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new GetCachePermissionTResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCachePermission_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getCachePermission_resultTupleSchemeFactory implements SchemeFactory {
      public getCachePermission_resultTupleScheme getScheme() {
        return new getCachePermission_resultTupleScheme();
      }
    }

    private static class getCachePermission_resultTupleScheme extends TupleScheme<getCachePermission_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getCachePermission_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getCachePermission_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
